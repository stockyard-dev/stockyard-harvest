...
const dashHTML = `<!DOCTYPE html><html><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1.0"><title>Harvest</title>
...
<div class="hdr"><h1><span>&#9670;</span> HARVEST</h1><button class="btn btn-p" id="add-btn">+ Add</button></div>
<div class="main"><div class="tabs" id="tabs"><div class="tab active" onclick="switchTab('crops')">Crops</div><div class="tab" onclick="switchTab('harvests')">Harvests</div></div><div class="tab-content active" id="tab-crops">
<div class="stats" id="stats-crops"></div>
<div class="toolbar">
<input class="search" id="search-crops" placeholder="Search..." oninput="renderRes('crops')"><select class="filter-sel" id="filter-crops-status" onchange="renderRes('crops')"><option value="">All Status</option><option value="Planned">Planned</option><option value="Planted">Planted</option><option value="Growing">Growing</option><option value="Ready">Ready</option><option value="Harvested">Harvested</option><option value="Failed">Failed</option></select></div>
<div class="count-label" id="count-crops"></div>
<div class="tbl-wrap"><table class="tbl"><thead><tr><th>Crop Name</th><th>Variety</th><th>Field/Plot</th><th>Planted</th><th>Expected Harvest</th><th>Status</th><th>Notes</th><th></th></tr></thead><tbody id="tbody-crops"></tbody></table></div></div><div class="tab-content" id="tab-harvests">
<div class="stats" id="stats-harvests"></div>
<div class="toolbar">
<input class="search" id="search-harvests" placeholder="Search..." oninput="renderRes('harvests')"><select class="filter-sel" id="filter-harvests-unit" onchange="renderRes('harvests')"><option value="">All Unit</option><option value="lbs">lbs</option><option value="kg">kg</option><option value="bushels">bushels</option><option value="tons">tons</option><option value="units">units</option><option value="bunches">bunches</option></select><select class="filter-sel" id="filter-harvests-quality" onchange="renderRes('harvests')"><option value="">All Quality</option><option value="Excellent">Excellent</option><option value="Good">Good</option><option value="Fair">Fair</option><option value="Poor">Poor</option></select></div>
<div class="count-label" id="count-harvests"></div>
<div class="tbl-wrap"><table class="tbl"><thead><tr><th>Crop ID</th><th>Harvest Date</th><th>Quantity</th><th>Unit</th><th>Quality</th><th>Notes</th><th></th></tr></thead><tbody id="tbody-harvests"></tbody></table></div></div></div><div class="modal-bg" id="mbg" onclick="if(event.target===this)closeModal()"><div class="modal" id="mdl"></div></div><script>var A="/api",data={},editId=null,activeRes="crops";var resCfg={"crops":{d:"Crops",f:[{n:"name",l:"Crop Name",t:"text",r:true,o:[]},{n:"variety",l:"Variety",t:"text",r:false,o:[]},{n:"field",l:"Field/Plot",t:"text",r:false,o:[]},{n:"planted_date",l:"Planted",t:"date",r:false,o:[]},{n:"expected_harvest",l:"Expected Harvest",t:"date",r:false,o:[]},{n:"status",l:"Status",t:"select",r:false,o:["Planned","Planted","Growing","Ready","Harvested","Failed"]},{n:"notes",l:"Notes",t:"textarea",r:false,o:[]}]},"harvests":{d:"Harvests",f:[{n:"crop_id",l:"Crop ID",t:"text",r:true,o:[]},{n:"date",l:"Harvest Date",t:"date",r:true,o:[]},{n:"quantity",l:"Quantity",t:"number",r:false,o:[]},{n:"unit",l:"Unit",t:"select",r:false,o:["lbs","kg","bushels","tons","units","bunches"]},{n:"quality",l:"Quality",t:"select",r:false,o:["Excellent","Good","Fair","Poor"]},{n:"notes",l:"Notes",t:"textarea",r:false,o:[]}]},};
